...
<iframe src="https://www.canva.com/design/DAFNVMsVj8s/oZqD20p-3rgER0YW5HXoyQ/view?utm_content=DAFNVMsVj8s&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton" frameborder="0" width="480" height="299" allowfullscreen="true" mozallowfullscreen="true" webkitallowfullscreen="true"></iframe>
...
- Good
  - トラブルに落ち着いて対応していた
  - 質問のとき、自分の意見を述べてから質問していた
  - 全体を通してリーダーシップを発揮していた
    - 進捗の確認
    - チームの雰囲気など状況を確認
    - 代表してAPIチームに質問
    - プロダクトの品質を確認
- More
  - 最初の段階で、完了まで逆算して段取りを組めれば良かった
